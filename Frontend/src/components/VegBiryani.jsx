...
function Mutton() {
  ...
  const [muttonItems, setMuttonItems] = useState([
    {
      ...
      image:
        "https://www.madhuseverydayindian.com/wp-content/uploads/2022/11/easy-vegetable-biryani.jpg", // Replace with actual image URL
      fullPlatePrice: 120,
      halfPlatePrice: 80,
    },
    {
  ...
  return (
    <div className="biryani-page mutton-bg">
      <h1>Veg Specials</h1>
      <p>Explore our delicious Non-Veg Biryani dishes.</p>
